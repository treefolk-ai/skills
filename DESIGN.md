...
| `insights` | `think` | `ai-workflow` | `synthesis` | Review a selected period of personal AI work and deliver evidence-backed improvements and verified feature suggestions in a local HTML report |
